...
{ label: 'Resume Builder', path: '/resume-builder', icon: FileText, enabled: true },
...
<> <div className="mb-8 flex items-start justify-between gap-4"> <div className="min-w-0"> <h1 className="text-2xl font-bold truncate">JTracker</h1> <p className="text-sm text-slate-500 truncate">Track every opportunity</p> </div>
...
return ( <div className="min-h-screen bg-slate-50 text-slate-900 overflow-x-hidden"> <header className="lg:hidden sticky top-0 z-40 bg-white/95 backdrop-blur border-b border-slate-200 px-4 py-3 flex items-center justify-between overflow-hidden">
<button
